...
{
    public partial class AddDishGastronomySM : Form
    {
        public AddDishGastronomySM()
        {
            InitializeComponent();
            Text = "Добавить блюдо в сезонное меню";

            // Настройка numericUpDown для веса (numericUpDown2)
            ...
            numericUpDown1.Minimum = 0.01m; // Минимальная цена 0.01
        ...
        private void AddDishGastronomySM_Load(object sender, EventArgs e)
        {
